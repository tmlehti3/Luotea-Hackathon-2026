...
Building maintenance is still largely driven by static maintenance schedules, fault notifications, and assumptions. Maintenance is performed because it is scheduled, not because the risk is increasing. Risks often remain invisible until they materialize for the end user as fault reports.
...
- What if the fixed maintenance schedule evolved in real time based on usage, load, and signals?
- What if failures could be detected before they occur, not only after a fault report?
...
| Dataset | Lentokentänkatu 11 | Venttiilitehdas | Toimisto | STD tehdas | Aurora House | Meridian Tower | Horizon Plaza | Notes |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| Smartti data | ❌ | ? | ? | ? | ✅ | ✅ | ✅ |  |
| KONE elevator data | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ | Available for anonymous sites |
| Alarms | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |  |
| Work orders | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ |  |
| Maintenance schedule | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ |  |
| Maintenance reports | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |  |
| Needs-based cleaning data | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |  |
| Service descriptions: technical property maintenance | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ |  |
| Service descriptions: property maintenance | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ |  |
| Service descriptions: cleaning | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ |  |
| Cleaning robots | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |  |
...
> **Note:** All mentors who are available on site for mentoring are also available for remote sparring.  
...
| Mentor | Osku Torro | [osku.torro@tuni.fi](mailto:osku.torro@tuni.fi) | 040 747 3375 | IT-business alignment, AI agents, real estate and construction businesses. Datasets: data products, data structures, data integration, and linkage. | Saturday 13:00–14:00 and 16:00–17:00. Available remotely via WhatsApp video call. |
...
|---:|---|
| 16:00 | Doors open |
| 17:00 | Hackathon starts and opening notes |
| 18:00 | Dinner |
| 20:00 | First mentoring checkpoint |
...
| 09:00 | Breakfast |
| 12:00 | Lunch |
| 13:00 | Second mentoring checkpoint |
| 18:00 | Dinner |
...
| 09:00 | Breakfast |
| 12:00 | Lunch |
| 13:00 | Pitching starts and judging |
...
Building maintenance is still largely driven by static maintenance schedules, fault notifications, and assumptions. Maintenance is performed because it is scheduled, not because the risk is increasing. Risks remain invisible until they materialize for the end user as fault reports.
...
Current data almost always describes the past. It reports, but does not guide. It explains, but does not predict.

Predictive maintenance is widely discussed, but it rarely translates into practical operations, contracts, or measurable services. Customers still purchase maintenance visits and working hours, even though the real need is operational reliability and risk management.
...
> What if failures could be detected before they actually occur, not only after a fault report?

At the core of this challenge is a shift:

- From working hours to outcomes
...
### 2. Dynamic Maintenance Calendar and Long-Term Planning

Consider the following questions:

- How could the need for maintenance visits be determined based on risk, usage, or load instead of a fixed calendar?
- How could the maintenance calendar evolve in real time based on data?
- How can both over-maintenance and under-maintenance be avoided within the same site?
- How can the difference between theoretical lifetime and actual condition be identified?
- How can small disturbances be used to predict larger investment needs?
